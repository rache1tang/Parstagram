    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (description.isEmpty()) { // there is no caption
                    Toast.makeText(getContext(), "Description cannot be empty!", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (photoFile == null || ivPicture.getDrawable() == null) { // there is no photo
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                // RESIZE BITMAP (IF YOUR EMULATOR HAS NO ROOM - view camera codepath page), see section below
    ...
    private void savePost(String description, ParseUser currentUser, File photoFile) {
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                ...
                etCaption.setText(""); // clear caption field
                ivPicture.setImageResource(0); // clear image
            }
        });
    }
